...
*/
const vars = (0, _vanilla_extract_css.createThemeContract)({
	color: {
		background: null,
		surface: null,
...
*/
const darkThemeClass = (0, _vanilla_extract_css.createTheme)(vars, {
	color: {
		background: "#0e0f11",
		surface: "#17181c",
...
*/
const lightThemeClass = (0, _vanilla_extract_css.createTheme)(vars, {
	color: {
		background: "#f8f9fb",
		surface: "#ffffff",
...
//#endregion
exports.darkThemeClass = darkThemeClass;
exports.lightThemeClass = lightThemeClass;
exports.themeClasses = themeClasses;
exports.vars = vars;
